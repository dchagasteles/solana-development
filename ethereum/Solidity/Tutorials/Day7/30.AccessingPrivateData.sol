...
/**Note
  ...
  Let's see how we can read private data.
  In the process you will learn how Solidity stores state variables.
 */
...
// Preventative Techniques: Don't store sensitive information on the blockchain.
